...
# Potential installs:
# pip install Flask, python -m pip install "pymongo[srv]"

# port 5000 for flask, port 3000 for react
...
```
cd existing_repo
git remote add origin https://git.cs.vt.edu/software-engineering-capstone-group-1/email-chatbot.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.cs.vt.edu/software-engineering-capstone-group-1/email-chatbot/-/settings/integrations)
